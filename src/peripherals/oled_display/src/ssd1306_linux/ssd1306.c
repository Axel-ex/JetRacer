...
uint8_t ssd1306_end() { return _i2c_close(); }
...
{
    if (oled_lines != SSD1306_128_64_LINES &&
        oled_lines != SSD1306_128_32_LINES && SSD1306_64_48_LINES)
        oled_lines = SSD1306_128_64_LINES;

    if (oled_columns != SSD1306_128_64_COLUMNS &&
        oled_lines != SSD1306_128_32_COLUMNS && SSD1306_64_48_COLUMNS)
...
uint8_t ssd1306_oled_write_string(uint8_t size, const char* ptr)
{
    uint8_t rc = 0;
