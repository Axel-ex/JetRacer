...
#include "bus_msgs/msg/detail/can_packet__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = bus_msgs::msg::CanPacket;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const bus_msgs::msg::CanPacket *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<bus_msgs::msg::CanPacket *>(
    untyped_ros_message);
...
{
  return &bus_msgs::msg::typesupport_fastrtps_cpp::_CanPacket__handle;
}
