...
#include "bus_msgs/msg/detail/can_frame__rosidl_typesupport_fastrtps_c.h"
...
using _CanFrame__ros_msg_type = bus_msgs__msg__CanFrame;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = bus_msgs__msg__CanFrame;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const bus_msgs__msg__CanFrame * ros_message = static_cast<const bus_msgs__msg__CanFrame *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_bus_msgs__msg__CanFrame(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  bus_msgs__msg__CanFrame * ros_message = static_cast<bus_msgs__msg__CanFrame *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_bus_msgs__msg__CanFrame(cdr, ros_message);
}

static uint32_t _CanFrame__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_bus_msgs__msg__CanFrame(
...
static size_t _CanFrame__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_bus_msgs__msg__CanFrame(
