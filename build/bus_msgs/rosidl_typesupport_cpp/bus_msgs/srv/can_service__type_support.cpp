...
static const _CanService_Request_type_support_symbol_names_t _CanService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bus_msgs, srv, CanService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bus_msgs, srv, CanService_Request)),
  }
};
...
{
  return &::bus_msgs::srv::rosidl_typesupport_cpp::CanService_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bus_msgs, srv, CanService_Request)() {
  return get_message_type_support_handle<bus_msgs::srv::CanService_Request>();
}
...
static const _CanService_Response_type_support_symbol_names_t _CanService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bus_msgs, srv, CanService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bus_msgs, srv, CanService_Response)),
  }
};
...
{
  return &::bus_msgs::srv::rosidl_typesupport_cpp::CanService_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bus_msgs, srv, CanService_Response)() {
  return get_message_type_support_handle<bus_msgs::srv::CanService_Response>();
}
...
static const _CanService_Event_type_support_symbol_names_t _CanService_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bus_msgs, srv, CanService_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bus_msgs, srv, CanService_Event)),
  }
};
...
{
  return &::bus_msgs::srv::rosidl_typesupport_cpp::CanService_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bus_msgs, srv, CanService_Event)() {
  return get_message_type_support_handle<bus_msgs::srv::CanService_Event>();
}
...
static const _CanService_type_support_symbol_names_t _CanService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bus_msgs, srv, CanService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bus_msgs, srv, CanService)),
  }
};
...
static const rosidl_service_type_support_t CanService_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<bus_msgs::srv::CanService_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<bus_msgs::srv::CanService_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<bus_msgs::srv::CanService_Event>(),
...
{
  return &::bus_msgs::srv::rosidl_typesupport_cpp::CanService_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, bus_msgs, srv, CanService)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<bus_msgs::srv::CanService>();
}
