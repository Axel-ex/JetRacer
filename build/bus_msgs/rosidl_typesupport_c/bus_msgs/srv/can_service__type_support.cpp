...
static const _CanService_Request_type_support_symbol_names_t _CanService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bus_msgs, srv, CanService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bus_msgs, srv, CanService_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bus_msgs, srv, CanService_Request)() {
  return &::bus_msgs::srv::rosidl_typesupport_c::CanService_Request_message_type_support_handle;
}
...
static const _CanService_Response_type_support_symbol_names_t _CanService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bus_msgs, srv, CanService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bus_msgs, srv, CanService_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bus_msgs, srv, CanService_Response)() {
  return &::bus_msgs::srv::rosidl_typesupport_c::CanService_Response_message_type_support_handle;
}
...
static const _CanService_Event_type_support_symbol_names_t _CanService_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bus_msgs, srv, CanService_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bus_msgs, srv, CanService_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bus_msgs, srv, CanService_Event)() {
  return &::bus_msgs::srv::rosidl_typesupport_c::CanService_Event_message_type_support_handle;
}
...
static const _CanService_type_support_symbol_names_t _CanService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bus_msgs, srv, CanService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bus_msgs, srv, CanService)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, bus_msgs, srv, CanService)() {
  return &::bus_msgs::srv::rosidl_typesupport_c::CanService_service_type_support_handle;
}
