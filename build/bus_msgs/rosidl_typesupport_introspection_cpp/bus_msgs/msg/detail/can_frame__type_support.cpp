...
{
  new (message_memory) bus_msgs::msg::CanFrame(_init);
}

void CanFrame_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bus_msgs::msg::CanFrame *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CanFrame_message_member_array[3] = {
  {
    ...
    offsetof(bus_msgs::msg::CanFrame, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bus_msgs::msg::CanFrame, data_len),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    8,  // array size
    false,  // is upper bound
    offsetof(bus_msgs::msg::CanFrame, data),  // bytes offset in struct
    nullptr,  // default value
...
{
  return &::bus_msgs::msg::rosidl_typesupport_introspection_cpp::CanFrame_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bus_msgs, msg, CanFrame)() {
  return &::bus_msgs::msg::rosidl_typesupport_introspection_cpp::CanFrame_message_type_support_handle;
}
