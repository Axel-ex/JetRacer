...
class CanService_Event(metaclass=Metaclass_CanService_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<bus_msgs/CanService_Request, 1>',
        'response': 'sequence<bus_msgs/CanService_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['bus_msgs', 'srv'], 'CanService_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['bus_msgs', 'srv'], 'CanService_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from bus_msgs.srv import CanService_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from bus_msgs.srv import CanService_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_CanService(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from bus_msgs.srv import _can_service
...
class CanService(metaclass=Metaclass_CanService):
    from bus_msgs.srv._can_service import CanService_Request as Request
    from bus_msgs.srv._can_service import CanService_Response as Response
    from bus_msgs.srv._can_service import CanService_Event as Event
